...
qqemail_sender = Email_Sender(config.softwareconfigdict['MAIL_USER'], config.softwareconfigdict['MAIL_PASS'], config.softwareconfigdict['MAIL_USER']+"@qq.com", config.softwareconfigdict['MAIL_USER']+"@qq.com")
notificationer = Notificationer(qqemail_sender)