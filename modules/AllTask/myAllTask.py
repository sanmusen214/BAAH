...
task_dict = {
    ...
    TaskName.BUY_AP.value: [InWanted, {}],
    TaskName.BOUNTY.value: [InSpecial, {}],
    TaskName.SPECIAL.value: [InExchange, {}],
    TaskName.SCHOOL_EXCHANGE_MEETING.value: [InContest, {'collect': False}],
    TaskName.TACTICAL_CHALLENGE.value: [AutoAssault, {}],
    TaskName.HARD.value: [InQuest, {'types': ["hard"]}],
    TaskName.EVENT.value: [InEvent, {}],
    TaskName.ASSAULT.value: [CollectDailyRewards, {}],
    TaskName.DAILY.value: [CollectMails, {}],
    TaskName.MAIL.value: [InQuest, {'types': ["normal"]}],
    TaskName.NORMAL.value: [InQuest, {'types': ["push-normal"]}],
    TaskName.PUSH_NORMAL.value: [InQuest, {'types': ["push-hard"]}],
    TaskName.PUSH_HARD.value: [AutoStory, {}],
    TaskName.MAIN_STORY.value: [BuyAP, {}],
